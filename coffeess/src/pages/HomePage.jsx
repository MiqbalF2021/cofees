...
const HomePage = () => {
  ...
  <div className="container mx-auto font-cuy">
    ...
    <div className="flex flex-col-reverse md:flex-row items-center justify-between mx-5 px-4 md:px-20 lg:px-24 bg-emerald-50 shadow-md rounded-3xl p-4 md:p-5">
    ...
    <div className="flex flex-col-reverse md:flex-row items-center mx-5 justify-between mt-8 px-4 md:px-20 lg:px-24 bg-orange-50 rounded-3xl shadow-md mb-20 p-4 md:p-10">
      <div className="w-full md:w-1/2">
        <h1 className="text-4xl md:text-5xl lg:text-6xl mt-3 font-bold mb-4">Sejarah</h1>
